...
(function() {
  var arg, args, bowerinstall, bowerupdate, cmd, exec, fin, fs, gitfetch, gitmeaning, gitpull, gitpush, gitstatus, gittopull, gittopush, npmupdate, nukebower, nukenpm, parallel, recordstderr, series, trybower, trydirectory, trygit, trygitstatus, trynpm, trynukebower, trynukenpm, usage, _i, _len, _stderr,
  ...
  for (_i = 0, _len = args.length; _i < _len; _i++) {
    arg = args[_i];
    if (arg !== 'pull' && arg !== 'push' && arg !== 'bower' && arg !== 'npm' && arg !== 'status' && arg !== 'nukenpm' && arg !== 'nukebower') {
      console.error(usage);
      process.exit(1);
    }
  }
