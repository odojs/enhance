...
var arg, args, bowerinstall, bowerupdate, cmd, exec, execOptions, fin, fs, gitfetch, gitmeaning, gitpull, gitpush, gitstatus, gittopull, gittopush, npmupdate, nukebower, nukenpm, odo, parallel, recordstderr, series, trybower, trydirectory, trygit, trygitstatus, trynpm, trynukebower, trynukenpm, tryodo, usage, _i, _len, _stderr,
...
cmd = function(cmd, cb) {
  return exec(cmd, execOptions, function(err, stdout, stderr) {
    if (err != null) {
...
gitpull = function(dir, cb) {
  return exec("cd " + dir + " && git pull", execOptions, function(err, stdout, stderr) {
    if (err != null) {
...
gitpush = function(dir, cb) {
  return exec("cd " + dir + " && git push", execOptions, function(err, stdout, stderr) {
    if (err != null) {
